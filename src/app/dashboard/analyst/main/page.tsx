...
import { getCoordinatorCases, CoordinatorCase, dashboardApi } from '@/features/dashboard/components/api/agent.api';
...
function AnalystDashboardContent() {
    ...
    const analystTabs = [
        ...
        { id: 'accepted', title: `Accepted & Under Review`, value: stats?.accepted, color: 'teal' as const, icon: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z" /><path d="M14 2v4a2 2 0 0 0 2 2h4" /><circle cx="10" cy="14" r="2" /><path d="m14 18-2.5-2.5" /></svg> },
        { id: 'bank', title: `Submitted to Bank`, value: stats?.atBank, color: 'purple' as const, icon: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m22 2-7 20-4-9-9-4Z" /><path d="M22 2 11 13" /></svg> },
        ...
        <div className="space-y-8 animate-in fade-in duration-500 pb-10">
                ...
                <section className="section-card bg-card border-border border shadow-sm rounded-2xl p-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
                        {[
                            { step: 1, label: 'Accept Case', desc: 'Review and accept new cases', color: 'bg-emerald-500/10 border-emerald-500/20 text-emerald-600 dark:text-emerald-400' },
                            { step: 2, label: 'Check Documents', desc: 'Verify all physical documents', color: 'bg-orange-500/10 border-orange-500/20 text-orange-600 dark:text-orange-400' },
                            { step: 3, label: 'Analyze Credit', desc: 'Review credit worthiness', color: 'bg-teal-500/10 border-teal-500/20 text-teal-600 dark:text-teal-400' },
                            { step: 4, label: 'Submit to Bank', desc: 'Send to preferred bank', color: 'bg-purple-500/10 border-purple-500/20 text-purple-600 dark:text-purple-400' },
                            { step: 5, label: 'Update Status', desc: 'Finalize based on bank response', color: 'bg-green-500/10 border-green-500/20 text-green-600 dark:text-green-400' },
                        ].map((s) => (
