                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-4 pt-4">
                        ...
                        {config && (
                            <button
                                ...
                                disabled={saving}
                                className="w-full sm:w-auto px-6 py-3 bg-card border border-red text-red rounded-xl font-bold text-xs uppercase tracking-widest hover:bg-red/5 transition-all active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                            >
                                <>
