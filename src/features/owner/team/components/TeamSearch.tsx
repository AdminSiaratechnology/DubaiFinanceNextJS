        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
            <div className="relative w-full sm:w-64">
                ...
                <input
                    ...
                    className="pl-10 pr-4 py-2 bg-card border border-border rounded-xl text-sm focus:ring-2 focus:ring-brand outline-none transition-all w-full"
                />
            </div>
            ...
            {showFilter && (
                <div className="relative w-full sm:w-auto">
                    ...
                    <select
                        ...
                        className="w-full pl-10 pr-10 py-2 bg-card border border-border rounded-xl text-sm font-semibold focus:ring-2 focus:ring-brand outline-none transition-all appearance-none cursor-pointer"
                    >
