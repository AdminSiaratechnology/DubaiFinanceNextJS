                    ...
                    <table className="w-full text-left border-collapse min-w-[1100px] lg:min-w-0">
                        <thead>
                            <tr className="bg-muted/50 border-b border-border">
                                ...
                                <th className="p-3 sm:p-4 text-[10px] font-bold text-text-muted uppercase tracking-widest text-right">
                                    Actions
                                </th>
                            </tr>
                        </thead>
                        ...
                        <tbody className="divide-y divide-border">
                            {rules.length > 0 ? (
                                    ...
                                    >
                                        ...
                                        <td className="p-3 sm:p-4">
                                            <div className="flex flex-col text-[11px] font-semibold">
                                                <span>Agent: {rule.agentShare}%</span>
                                                <span>Telecaller: {rule.telecallerShare}%</span>
                                                <span>Coordinator: {rule.coordinatorShare}%</span>
                                            </div>
                                        </td>
                                ...
                                <tr>
                                    ...
                                    >
                                        No commission rules found matching your search.
                                    </td>
                                </tr>
                            )}
                        </tbody>
