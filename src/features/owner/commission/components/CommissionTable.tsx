                        ...
                        <table className="w-full text-left border-collapse min-w-[1100px] lg:min-w-0">
                            <thead>
                                <tr className="bg-foreground/10 border-b border-border">
                                    ...
                                    <th className="p-3 sm:p-4 text-[14px] font-bold text-adaptive uppercase tracking-widest">Product</th>
                                    <th className="p-3 sm:p-4 text-[14px] font-bold text-adaptive uppercase tracking-widest">Commission</th>
                                    <th className="p-3 sm:p-4 text-[14px] font-bold text-adaptive uppercase tracking-widest">Shares (%)</th>
                                    <th className="p-3 sm:p-4 text-[14px] font-bold text-adaptive uppercase tracking-widest">Effective From</th>
                                ...
                                {rules.length > 0 ? (
                                    rules.map((rule, index) => (
                                        <tr key={rule.id} className="hover:bg-muted/30 transition-colors group">
                                            ...
                                            <td className="p-3 sm:p-4">
                                                <div>
                                                    <p className="text-sm sm:text-sm font-medium text-adaptive">{rule.bank?.name ?? '-'}</p>
                                                </div>
                                            </td>
                                            ...
                                            <td className="p-3 sm:p-4">
                                                <div className="flex flex-col">
                                                    <span className="text-[14px] font-bold text-adaptive">
                                            ...
                                            {/* Shares */}
                                            <td className="p-3 sm:p-4">
                                                <div className="flex flex-col text-[12px] font-semibold text-adaptive gap-0.5">
                                            ...
                                            {/* Effective Date */}
                                            <td className="p-3 sm:p-4">
                                                <span className="text-sm sm:text-sm font-medium text-adaptive">
                                            ...
                                            <td className="p-3 sm:p-4">
                                                <div className="flex items-center justify-end gap-2">
                                                    ...
                                                    <span className={`text-sm font-bold ${rule.status === 'active' ? 'text-green' : 'text-red'}`}>
