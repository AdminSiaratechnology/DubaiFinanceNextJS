...
export function DashboardSidebar({ isOpen, onClose }: DashboardSidebarProps) {
    ...
    const [expandedItems, setExpandedItems] = React.useState<string[]>(() => {
        // Initialize with items that are parents of the current path
    ...
    return (
        <>
            ...
            <aside className={`
                fixed inset-y-0 left-0 z-60 w-72 bg-card border-r border-border shadow-2xl transition-transform duration-300 lg:translate-x-0 lg:static lg:flex lg:flex-col lg:shadow-none
            ...
            `}>
                ...
                <nav className="flex-1 px-4 mt-8 space-y-2 overflow-y-auto no-scrollbar">
                    ...
                    {sortedNavItems.map((item) => {
                        ...
                        // Fix: Ensure exact path matching to prevent /owner/bank matching /owner/bankproducts
